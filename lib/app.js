...
app.get('/characters', async(req, res) => {
  try {
    const data = await client.query(
      `SELECT categories.category_name, characters.owner_id, characters.name, characters.good_guy, characters.image_url, characters.age, characters.category_id, characters.quote, characters.id as char_id FROM characters
      JOIN categories ON characters.category_id = categories.id`
    );
