...
app.get('/characters', async(req, res) => {
  try {
    const data = await client.query(
      `SELECT characters.name, characters.good_guy, characters.image_url, characters.age, characters.category_id, characters.quote, characters.id as char_id FROM characters
